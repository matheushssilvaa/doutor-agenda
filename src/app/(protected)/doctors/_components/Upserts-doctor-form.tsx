...
const formSchema = z.object({
	...
	specialty: z.string().trim().min(1, { message: "A especialidade é obrigatória" }),
	appointmentPrice: z.number().min(1, { message: "O preço da consulta é obrigatório" }),
	availableFromWeekDay: z.string(),
	availableToWeekDay: z.string(),
	availableFromTime: z.string().min(1, { message: "A hora de inicio é obrigatória" }),
	availableToTime: z.string().min(1, { message: "A hora de término é obrigatória" })
}).refine((data) => {
